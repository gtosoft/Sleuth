...
//	VoyagerStatusBox mStatusBox = null;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        tvMessages = (TextView) findViewById(R.id.tvMain);
...
//					ioStateChanged(newState);
				...
				if (newState > 0) {
					...
					msg ("Session detection resulted in " + ret);
		...
		private boolean setButtonEventHandlers () {
			...
			btnLock.setOnClickListener(new OnClickListener() {
				public void onClick(View v) {
					...
					msg ("Sending Lock command");
					hs.getCommandSession().sendCommand("FOB_LOCK");
				}// end of OnClick
			...
			btnUnlock.setOnClickListener(new OnClickListener() {
				public void onClick(View v) {
					...
					hs.getCommandSession().sendCommand("FOB_UNLOCK");
				}// end of onclick. 
			}); // end of setonclicklistener.
